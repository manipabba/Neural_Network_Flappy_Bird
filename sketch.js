...
function draw(){
  ...
  textFont('VT323');
  if(ifTrain){
    text("Generation: " + generationCount, width - (width/5), height/30, width/5, height/20);
  }
  else{
    text("Generation: N/A", width - (width/5), height/30, width/5, height/20);
  }
  text("Number of Birds: " + birdArray.length, width - (width/5), height/30 + height/20, width/5, height/20);
